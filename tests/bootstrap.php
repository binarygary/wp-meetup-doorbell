<?php
/**
 * WP_Meetup_Doorbell Test Bootstrapper.
 *
 * @since   0.1.0
 ...
 * @since 0.1.0
 */
function _manually_load_wp_meetup_doorbell_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/wp-meetup-doorbell.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_wp_meetup_doorbell_plugin' );
